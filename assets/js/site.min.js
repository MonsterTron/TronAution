var contractAddress = 'TXk2TRvTiBCWa2iZBdHzbAeb8nHK47QKgc';
...
var defaultTopAddress = 'TBSpooUA1cTL81PjHNoYXgysUMuNYoBE7K';
...
$(function () {
	async function getSiteStats() {
		...
		async function getpoolAuctInfo() {
			...
			userATop4 = tronWebExt.address.fromHex(res[1][3]);
			userATop4 = tronWebExt.address.fromHex(res[1][4]);
			...
			userAmountATop4 = tronWebExt.toDecimal(res[2][3]);
			userAmountATop5 = tronWebExt.toDecimal(res[2][4]);
			...
			userAmountATop4Trx = userAmountATop4 / 1000000;
			userAmountATop4Trx = parseFloat(getFormattedNumber(userAmountATop4Trx));

			userAmountATop5Trx = userAmountATop5 / 1000000;
			userAmountATop5Trx = parseFloat(getFormattedNumber(userAmountATop5Trx));
			...
			auctionIncomeTop1 = ((auctionIncomeTrx + poolAuctionBalancePrizes) * 60) / 100;
			auctionIncomeTop1 = parseFloat(getFormattedNumber(auctionIncomeTop1));
	
			auctionIncomeTop2 = ((auctionIncomeTrx + poolAuctionBalancePrizes) * 15) / 100;
			auctionIncomeTop2 = parseFloat(getFormattedNumber(auctionIncomeTop2));
	
			auctionIncomeTop3 = ((auctionIncomeTrx + poolAuctionBalancePrizes) * 5) / 100;
			auctionIncomeTop3 = parseFloat(getFormattedNumber(auctionIncomeTop3));

			auctionIncomeTop4 = ((auctionIncomeTrx + poolAuctionBalancePrizes) * 3) / 100;
			auctionIncomeTop4 = parseFloat(getFormattedNumber(auctionIncomeTop4));

			auctionIncomeTop5 = ((auctionIncomeTrx + poolAuctionBalancePrizes) * 2) / 100;
			auctionIncomeTop5 = parseFloat(getFormattedNumber(auctionIncomeTop5));

			auctionLastIncomeTop1 = (auctionLastIncomeTrx * 60) / 100;
			auctionLastIncomeTop1 = parseFloat(getFormattedNumber(auctionLastIncomeTop1));

			auctionLastIncomeTop2 = (auctionLastIncomeTrx * 15) / 100;
			auctionLastIncomeTop2 = parseFloat(getFormattedNumber(auctionLastIncomeTop2));

			auctionLastIncomeTop3 = (auctionLastIncomeTrx * 5) / 100;
			auctionLastIncomeTop3 = parseFloat(getFormattedNumber(auctionLastIncomeTop3));

			auctionLastIncomeTop4 = (auctionLastIncomeTrx * 3) / 100;
			auctionLastIncomeTop4 = parseFloat(getFormattedNumber(auctionLastIncomeTop4));

			auctionLastIncomeTop5 = (auctionLastIncomeTrx * 2) / 100;
		 ...
		 if (userATop3 == defaultTopAddress){
			...
			$('.auctionIncomeTop3').html(auctionIncomeTop3);
		 	 ...
		 	 if (userATop3 == defaultTopAddress){
			$('.userATop3').html("😢 No Participant");
			$('.auctionIncomeTop4').html("0");
		 }else{
			$('.userATop3').html(userATop3.substr(0,8) + "...");
			$('.auctionIncomeTop4').html(auctionIncomeTop4);
		 }
		 	 if (userATop3 == defaultTopAddress){
			$('.userATop3').html("😢 No Participant");
			$('.auctionIncomeTop5').html("0");
		 }else{
			$('.userATop3').html(userATop3.substr(0,8) + "...");
			$('.auctionIncomeTop5').html(auctionIncomeTop5);
		 }
			...
			$('.userAmountATop4Trx').html(userAmountATop4Trx);
			$('.userAmountATop5Trx').html(userAmountATop5Trx);
